...
import com.adhiraj.myshield.Classes.RecyclerViewAdapter;
...
//      initialize firestore
    ...
    private void getData(String city_name) {
        ...
        fStore.collection(city_name).orderBy("date", Query.Direction.DESCENDING).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
